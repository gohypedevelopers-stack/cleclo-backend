...
async function main() {
    ...
    try { await prisma.riderProfile.deleteMany(); } catch (e) {}
    ...
    const customerNames = [
        ...
        { id: '44444444-4444-4444-4444-444444444445', name: 'Sneha Reddy', email: 'sneha@example.com', phone: '9876543213', type: 'regular' },
    ];
    ...
    const maintenanceReopenDate = new Date();
    maintenanceReopenDate.setDate(maintenanceReopenDate.getDate() + 5);
    maintenanceReopenDate.setHours(10, 0, 0, 0);
    ...
    const vendorData = [
        ...
        },
        {
            ...
            businessType: 'Processing Hub',
            isMaintenance: true,
            reopenDate: maintenanceReopenDate,
            totalRevenue: 192000,
            commissionEarned: 32640,
            refundAmount: 4600,
            totalOrders: 185,
            currentLoad: 42,
            slaScore: 82,
        ...
        },
        {
            ...
            area: 'Worli',
            cluster: 'South Mumbai',
            businessType: 'Collection Centre',
            totalRevenue: 34000,
            commissionEarned: 0,
            refundAmount: 0,
            totalOrders: 22,
        ...
        },
        {
            ...
            area: 'Santacruz East',
            cluster: 'Western Suburbs',
            businessType: 'Experience Store',
            totalRevenue: 214000,
            commissionEarned: 40660,
            refundAmount: 2300,
            totalOrders: 168,
            currentLoad: 74,
            slaScore: 78,
            ...
            data: {
                ...
                vendorProfile: {
                    create: {
                        ...
                        city: vData.city,
                        area: vData.area,
                        cluster: vData.cluster,
                        gstRegistered: true,
                        gstNumber: `GST${Math.random().toString(36).substring(2, 15).toUpperCase()}`,
                        businessType: vData.businessType || 'Standard Store',
                        ...
                        isMaintenance: vData.isMaintenance || false,
                        reopenDate: vData.isMaintenance ? vData.reopenDate : null,
                        totalRevenue: vData.totalRevenue || 0,
                        commissionEarned: vData.commissionEarned || 0,
                        refundAmount: vData.refundAmount || 0,
                        totalOrders: vData.totalOrders || 0,
                        currentLoad: vData.currentLoad || 0,
                        slaScore: vData.slaScore || 0,
                        rating: vData.rating || 0,
                        issueRate: vData.issueRate || 0,
                        areaCoverage: vData.areaCoverage || 'Thane East, Thane West',
                    },
                },
                outlets: {
                    create: [
